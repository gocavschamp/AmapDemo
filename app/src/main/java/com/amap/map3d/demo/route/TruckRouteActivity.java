...
//	private LatLonPoint mStartPoint = new LatLonPoint(39.902896,116.42792);
	private LatLonPoint mStartPoint = new LatLonPoint(39.861181,116.456498);
//	private LatLonPoint mEndPoint = new LatLonPoint(39.894914,116.322062);//终点，39.995576,116.481288
	private LatLonPoint mEndPoint = new LatLonPoint(31.245353,121.395036);//终点，39.995576,116.481288
...
//	DRIVING_MULTIPLE_ROUTES_PRIORITY_HIGHSPEED
	...
	public void searchRouteResult( int mode) {
		...
		RouteSearch.TruckRouteQuery query = new RouteSearch.TruckRouteQuery(fromAndTo,RouteSearch.TRUCK_CHOICE_HIGHWAY, null, RouteSearch.TRUCK_SIZE_HEAVY);
		...
		if (rCode == 1000) {
			if (result != null && result.getPaths() != null
				...
				for (int i = 0; i < result.getPaths().size(); i++) {
					TruckPath path = truckRouteResult.getPaths().get(i);
					if(path == null) {
						return;
					}
...
//					drivingRouteOverlay.removeFromMap();
					drivingRouteOverlay.setRouteWidth(30-10*i);
